  ...
  return (
    <div className="bento-grid">
      <div className="grid-item-overlay-1760057571577">
        <h1 className="text-center text-xl headingA text-yellow-500 lg:text-8xl">Gastlichkeit ist unsere Philosophie</h1>
      </div>
      ...
      <div className="grid-item-overlay-1760057632942">
        <div className="mt-[3vh] flex flex-col items-center space-x-4 justify-center h-[70vh] w-[]">
         ...
         <h1 className="mt-[5vh] text-4xl text-center headingA text-yellow-500 lg:text-5xl">Flens vom Fass</h1>
